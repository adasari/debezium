...
public class DefaultChangeEventQueue<T extends Sizeable> extends AbstractChangeEventQueue<T> {
    ...
    // TODO: replace CommonConnectorConfig with Configuration ?
    public DefaultChangeEventQueue(Configuration config, Supplier<PreviousContext> loggingContextSupplier) {
        super(loggingContextSupplier);
//        this.pollInterval = config.getPollInterval();
//        this.maxBatchSize = config.getMaxBatchSize();
//        this.maxQueueSize = config.getMaxQueueSize();
//        this.maxQueueSizeInBytes = config.getMaxQueueSizeInBytes();
        ...
        this.pollInterval = config.getDuration(CommonConnectorConfig.POLL_INTERVAL_MS, ChronoUnit.MILLIS);
        this.maxQueueSizeInBytes = config.getLong(CommonConnectorConfig.MAX_QUEUE_SIZE_IN_BYTES);
