 ...
 */
@ThreadSafe
public class DeprecatedChangeEventQueue<T extends Sizeable> implements ChangeEventQueueMetrics {

    private static final Logger LOGGER = LoggerFactory.getLogger(DeprecatedChangeEventQueue.class);
    ...
    private DeprecatedChangeEventQueue(Duration pollInterval, int maxQueueSize, int maxBatchSize, Supplier<LoggingContext.PreviousContext> loggingContextSupplier,
    ...
    public static class Builder<T extends Sizeable> {
        ...
        public DeprecatedChangeEventQueue<T> build() {
            return new DeprecatedChangeEventQueue<T>(pollInterval, maxQueueSize, maxBatchSize, loggingContextSupplier, maxQueueSizeInBytes, buffering);
        }
    }
