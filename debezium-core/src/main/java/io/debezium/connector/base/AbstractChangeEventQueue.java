...
public abstract class AbstractChangeEventQueue<T extends Sizeable> implements ChangeEventQueue<T> {
    ...
    protected Supplier<LoggingContext.PreviousContext> loggingContextSupplier;
    ...
    public AbstractChangeEventQueue(Supplier<LoggingContext.PreviousContext> loggingContextSupplier) {
